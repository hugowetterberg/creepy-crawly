    ...
    var angle = 0,
        ...
        process = function (j) {
            var value = values[j],
                ...
                txt = paper.text(cx + (r + delta + 0) * Math.cos(-popangle * rad), cy + (r + delta + 0) * Math.sin(-popangle * rad), labels[j]).attr({stroke: "none", opacity: 0, "font-family": 'Fontin-Sans, Arial', "font-size": "15px"});
